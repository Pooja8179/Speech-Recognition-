...
# Set up and train the AdaBoost model with decision stumps as the base estimator
base_estimator = DecisionTreeClassifier(max_depth=12)
ada_model = AdaBoostClassifier(base_estimator=base_estimator, n_estimators=3000, random_state=42)
